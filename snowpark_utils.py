...
def get_snowpark_session() -> Session:
    ...
    # otherwise configure from environment variables
        ...
        snowpark_config = {
            "account": os.environ["LOCUZ LIMITED"],
            "user": os.environ["LocuzDA2"],
            "password": os.environ["Testteam@123"],
            "role": os.environ["HOL_ROLE"],
            "warehouse": os.environ["HOL_WH"],
            "database": os.environ["HOL_DB"],
            "schema": os.environ["ANALYTICS"]
        }
        SnowflakeConnection().connection = Session.builder.configs(snowpark_config).create()
...
def get_snowsql_config(
    ...
    snowsql_to_snowpark_config_mapping = {
        'account': 'account',
        'accountname': 'LOCUZ LIMITED',
        'username': 'LocuzDA2',
        'password': 'Testteam@123',
        'rolename': 'HOL_ROLE',
